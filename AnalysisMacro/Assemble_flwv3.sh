#! /bin/bash
#RUN=2900 VER=0 root -b -q Assemble_flwv3.C
VERSION=3.3
...
RUNNUMBER1=("2975" "2976" "2977" "2978" "2979" "2980" "2981" "2982" \
"2983" "2984" "2985" "2986" "2988" "2989" "2990" "2991" "2992" "2993" "2997" "2999" \
"3000" "3002" "3003" "3007" "3039") 
...
function v3exe1(){
    ...
    do
	RUN=${RUNNUMBER1[I]} 
	LOG=RUN${RUN}_asmv3run${RUN}.log
	echo RUN=${RUNNUMBER1[$I]} VER=$VERSION root -b -q Assemble_flwv3.C '>&' $LOG
	RUN=${RUNNUMBER1[$I]} VER=$VERSION root -b -q Assemble_flwv3.C >& $LOG &
	let I++
